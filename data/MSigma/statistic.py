...
if __name__ == "__main__":
    ...
    df_CK1a_orthosteric['ZScore'] = df_CK1a_orthosteric['ZScore_A']
    df_CK1a_allosteric['ZScore'] = np.mean(df_CK1a_allosteric[['ZScore_A', 'ZScore_A_inh']], axis=1)
    df_CK1a_cryptic['ZScore'] = df_CK1a_cryptic['ZScore_A_inh']
    df_effectsize_boxenplot = pd.concat([df_CK1a_orthosteric, df_CK1a_allosteric, df_CK1a_cryptic])
    sns.boxenplot(data=df_effectsize_boxenplot.sort_values('customlabel'), x='customlabel', y='ZScore', palette=palette)    
    ...
    df_CK1d_orthosteric['ZScore'] = df_CK1d_orthosteric['ZScore_D']
    df_CK1d_allosteric['ZScore'] = np.mean(df_CK1d_allosteric[['ZScore_D', 'ZScore_D_inh']], axis=1)
    df_CK1d_cryptic['ZScore'] = df_CK1d_cryptic['ZScore_D_inh']
