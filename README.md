...
Published paper: **Iqbal S***, Jiang W, Hansen E, Aristotelous T, Liu S, Reidenbach A, et al. **Evaluation of DNA encoded library and machine learning model combinations for hit discovery**. _NPJ Drug Discovery (accepted)_. Feb **2025**.
